...
def parse_arguments():
    ...
    parser.add_argument('name', help='Please, insert the capital',
                        'or the state')
    parser.add_argument('-v', '--verbosity', help='Incrementally',
                        'increase the verbosity', action='count', default=0)
